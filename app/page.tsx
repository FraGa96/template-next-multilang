...
const VERCEL_URL_TEMPLATE =
  'https://vercel.com/templates/next.js?utm_source=create-next-app&'
  + 'utm_medium=appdir-template-tw&utm_campaign=create-next-app';
const VERCEL_URL_LEARNING =
  'https://vercel.com/guides?utm_source=create-next-app'
  + '&utm_medium=appdir-template-tw&utm_campaign=create-next-app';
const VERCEL_URL_DEPLOY =
  'https://vercel.com/new?utm_source=create-next-app&utm_medium=appdir-template-tw'
  + '&utm_campaign=create-next-app';
const VERCEL_URL_DOCS =
  'https://vercel.com/docs?utm_source=create-next-app&utm_medium=appdir-template-tw'
  + '&utm_campaign=create-next-app';
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          ...
          <a
            className={'flex h-12 w-full items-center justify-center rounded-full'
              ...
              + ' dark:border-white/[.145] dark:hover:bg-[#1a1a1a] md:w-39.5'}
            href={VERCEL_URL_DOCS}
            target="_blank"
            rel="noopener noreferrer"
          >
            Documentation
